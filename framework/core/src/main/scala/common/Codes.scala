...
object Codes {
  ...
  case object RECIPIENT_NOT_CONTACTABLE extends StatusCode(-112, "RECIPIENT_NOT_CONTACTABLE", "The specified recipient has elected to not receive communications from Didd")
