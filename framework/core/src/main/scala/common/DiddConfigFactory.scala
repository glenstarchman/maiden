...
object DiddConfigFactory {
  ...
  lazy val cloudinaryConfig = Map(
    "cloudinary.cloud" -> conf.getString("cloudinary.cloud"),
    "cloudinary.api_key" -> conf.getString("cloudinary.api_key"),
    "cloudinary.api_secret" -> conf.getString("cloudinary.api_secret"),
    "cloudinary.url" -> conf.getString("cloudinary.url")
  )
  ...
  lazy val config = generalConfig ++ cloudinaryConfig ++ basicAuth ++ 
