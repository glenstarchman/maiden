...
import com.maiden.framework.common.DiddConfigFactory.config
...
class Mailer {
  ...
  val testMessage = new MSendMsg(
    ...
    bcc_address = "glen@didd.com",
    to = List(MTo("glen@didd.com")),
    tracking_domain = "didd.com",
    signing_domain = "didd.com",
    return_path_domain = "didd.com"
  )
