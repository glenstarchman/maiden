...
class DiddPostgreSqlAdapter extends PostgreSqlAdapter {
...
object DiddSchema extends Schema with  PrimitiveTypeMode with Log {
  ...
  implicit class UpsertableTable[T <: BaseDiddTableWithTimestamps](t: Table[T]) {
