...
import com.maiden.framework.common.DiddConfigFactory.generalConfig
...
case class User(override var id: Long=0, 
  ...
  extends FriendlyIdable with BaseDiddTableWithTimestamps {
...
object User extends CompanionTable[User] {
  ...
  def createIdentity(userName: String, password: String, email: String): Option[User] = {
   ...
   val reserved = List("didd", "admin", "root", "create",
                       "update", "delete", "god")
